...
var Page = class extends AbstractPage {
  constructor(client, response2, body, options) {
    super(client, response2, body, options);
    this.data = body.data || [];
...
var Runs = class extends APIResource {
  ...
  async poll(threadId, runId, options) {
    ...
    while (true) {
      const { data: run, response: response2 } = await this.retrieve(threadId, runId, {
        ...options,
...
var FileBatches = class extends APIResource {
  ...
  async poll(vectorStoreId, batchId, options) {
    ...
    while (true) {
      const { data: batch, response: response2 } = await this.retrieve(vectorStoreId, batchId, {
        ...options,
        headers
      }).withResponse();
      switch (batch.status) {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1731240450814.7078";
}
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/dashboard.$docId.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1731242752077.2212";
}
...
function Block() {
  ...
  const data = useData(`/PillBoxes/${docId}`);
  const [eff, setEff] = (0, import_react2.useState)();
  const [dir, setDir] = (0, import_react2.useState)();
  const [war, setWar] = (0, import_react2.useState)();
  (0, import_react2.useEffect)(() => {
    if (!data)
      return;
    if (!eff)
      response(`tell me about strictly the positive effects of ${data?.name}`).then((v) => {
        setEff(v.message.content ?? "");
      });
    if (!dir)
      response(`tell me strictly about the drug use directions of ${data?.name}`).then((v) => {
        setDir(v.message.content ?? "");
      });
    if (!war)
      response(`tell me strictly the warnings and side effects of ${data?.name}`).then((v) => {
        setWar(v.message.content ?? "");
      });
  }, [data]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-11/12 flex-1 p-[2vw] flex flex-col items-center", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-row items-center relative w-fit text-[6rem] font-black", children: [
      data?.name,
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "absolute right-0 m-auto w-[calc(100%+48px)]", onClick: () => {
        ...
        setDir("");
        setWar("");
      }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(FaEdit, { size: 32 }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-row relative w-fit text-[1.5rem] font-light", onClick: () => {
      const newInterval = prompt("Enter new interval");
      updateData(`/PillBoxes/${docId}`, {
        takeTimeInterval: Number.parseInt(newInterval ?? "10")
      });
    }, children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-medium", children: "Interval" }, void 0, false, {
        fileName: "app/routes/dashboard.$docId.tsx",
        lineNumber: 75,
        columnNumber: 13
      }, this),
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { variants: child, className: "w-full flex flex-col p-[2.5vw] mt-[2rem] gap-[1rem] rounded-2xl border-gray-200 border-2 shadow-xl", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-row items-center gap-[0.5rem]", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(BsFillQuestionCircleFill, { size: 40 }, void 0, false, {
          fileName: "app/routes/dashboard.$docId.tsx",
          lineNumber: 79,
          columnNumber: 17
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "text-[2rem] font-medium", children: "Effects" }, void 0, false, {
          fileName: "app/routes/dashboard.$docId.tsx",
          lineNumber: 80,
          columnNumber: 17
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "text-[1.5rem]", children: eff }, void 0, false, {
        fileName: "app/routes/dashboard.$docId.tsx",
        lineNumber: 84,
        columnNumber: 13
      }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { variants: child, className: "w-full flex flex-col p-[2.5vw] mt-[2rem] gap-[1rem] rounded-2xl border-gray-200 border-2 shadow-xl", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-row items-center gap-[0.5rem]", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(IoIosCheckmarkCircle, { size: 40 }, void 0, false, {
          fileName: "app/routes/dashboard.$docId.tsx",
          lineNumber: 90,
          columnNumber: 17
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "text-[2rem] font-medium", children: "Directions" }, void 0, false, {
          fileName: "app/routes/dashboard.$docId.tsx",
          lineNumber: 91,
          columnNumber: 17
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "text-[1.5rem]", children: dir }, void 0, false, {
        fileName: "app/routes/dashboard.$docId.tsx",
        lineNumber: 95,
        columnNumber: 13
      }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(motion.div, { variants: child, className: "w-full flex flex-col p-[2.5vw] mt-[2rem] gap-[1rem] rounded-2xl border-gray-200 border-2 shadow-xl", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-row items-center gap-[0.5rem]", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(IoIosWarning, { size: 40 }, void 0, false, {
          fileName: "app/routes/dashboard.$docId.tsx",
          lineNumber: 101,
          columnNumber: 17
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "text-[2rem] font-medium", children: "Warning" }, void 0, false, {
          fileName: "app/routes/dashboard.$docId.tsx",
          lineNumber: 102,
          columnNumber: 17
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "text-[1.5rem] leading-[2.25rem]", children: war }, void 0, false, {
        fileName: "app/routes/dashboard.$docId.tsx",
        lineNumber: 106,
        columnNumber: 13
      }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button, { className: "mt-[2rem] self-start text-[1.5rem] p-[2rem]", variant: "outline", onClick: () => {
      console.log("clonk");
      updateData(`/PillBoxes/${docId}`, {
...
_s(Block, "K75xtI4yDJJUsSWyo/5FV205H8Q=", false, function() {
...
//# sourceMappingURL=/build/routes/dashboard.$docId-VYUCDEJE.js.map
